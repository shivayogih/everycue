...
class EveryCueApplication : Application() {
    ...
    val userProfileRepository: LocalUserProfileRepository by lazy { LocalUserProfileRepository(this) }
    val backupRepository: BackupRepository by lazy {
        BackupRepository(this, database, packRepository, settingsRepository, userProfileRepository)
    }
